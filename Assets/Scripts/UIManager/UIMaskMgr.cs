...
namespace LYFrameWork
{
	public class UIMaskMgr : MonoBehaviour {
	    ...
	    public void SetMaskWindow(GameObject goDisplayUIForms, UIFormLucenyType lucenyType = UIFormLucenyType.Lucency, bool isMaskPanelStay = false)
        {
	        //顶层窗体下移
